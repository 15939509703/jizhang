...
public final class ErrorCodes {
    ...
    public static final String PHONE_ALREADY_REGISTERED = "AUTH_PHONE_ALREADY_REGISTERED";
    public static final String PHONE_BINDING_INVALID = "AUTH_PHONE_BINDING_INVALID";
