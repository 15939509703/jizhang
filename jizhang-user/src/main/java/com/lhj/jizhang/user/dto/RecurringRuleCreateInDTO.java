...
@Schema(name = "RecurringRuleCreateRequest", description = "创建周期账单规则请求")
public record RecurringRuleCreateInDTO(
        ...
        @NotNull(message = "执行日不能为空") @Min(value = 1, message = "执行日不能小于1")
        @Max(value = 31, message = "执行日不能大于31") Integer executionDay,
